		...
		<div id="call-to-action">
			<div class="container">
				<div class="col span_3">
					<div class="cta-head"> <?php echo $options['cta-text']; ?> </div>
				</div>
				<div class="col span_7">
					<div class="cta-cont"> <?php echo $options['cta-text']; ?> </div>
				</div>
		...
		<div class="row" id="copyright">
			...
			<div class="container">
				...
				<div class="col span_3">
					<div class="footer-logo">
						<a id="logo" href="<?php echo home_url(); ?>" <?php echo $logo_class; ?>>
							<img src="/wp-content/uploads/2018/06/Group-54.png" />
						</a>	
					</div>
				</div>	
				...
				<div class="col span_3 col_last">
					<ul id="social">
						<?php  if(!empty($options['use-twitter-icon']) && $options['use-twitter-icon'] == 1) { ?> <li><a target="_blank" href="https://twitter.com/hoopesvision"><i class="fa fa-twitter"></i> </a></li> <?php } ?>
						<?php  if(!empty($options['use-facebook-icon']) && $options['use-facebook-icon'] == 1) { ?> <li><a target="_blank" href="https://www.facebook.com/hoopesvision"><i class="fa fa-facebook"></i> </a></li> <?php } ?>
						...
						<?php  if(!empty($options['use-youtube-icon']) && $options['use-youtube-icon'] == 1) { ?> <li><a target="_blank" href="https://www.youtube.com/user/HoopesVision"><i class="fa fa-youtube-play"></i> </a></li> <?php } ?>
						...
						<?php  if(!empty($options['use-instagram-icon']) && $options['use-instagram-icon'] == 1) { ?> <li><a target="_blank" href="https://instagram.com/HoopesVision/"><i class="fa fa-instagram"></i></a></li> <?php } ?>
...
<script>
jQuery(function($){
	$(".blog-title .author-section").prependTo(".blog-title .inner-wrap");
	setTimeout(function()
			{
			$(".minimal-form-input").removeClass("minimal-form-input");
			},3000);
			
 $('li#menu-item-16437 a').click(function() {
	window.open('https://www.carecredit.com/apply/confirm.html?encm=AmNRaFAyUDUDPwRgBjINZFRuVjRXNFdgD2hWYFI9ATA');
 });
 
 			
 $('li#menu-item-16438 a').click(function() {
	window.open('https://www.carecredit.com/payment_calculator/template.html?amount=2500&ss=http%3A%2F%2Fcarecredit.com%2Fpayment_calculator%2Ftemplate.css&ASPS=0&keys=&referrer_url=&x=6&y=9');
 });

 $('#call-to-action .col_last a').click(function() {
	window.open('/schedule-a-consultation/','_self');
 });
 
	
 $('#custom_html-2').click(function() {
	window.open('/lasik/our-experience/','_self');
 });
 ...
 $('#custom_html-3').click(function() {
	window.open('/lasik/technology/','_self');
 });
 
  $('#custom_html-4').click(function() {
	window.open('/about-us/our-facility/','_self');
 });
