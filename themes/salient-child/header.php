...
})(window,document,'script','dataLayerZypmedia','GTM-PFFGWWG');</script>
<!-- End Google Tag Manager -->

<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PFFGWWG"
...
<script type="text/javascript" src="/wp-content/themes/salient-child/js/jquery.exitintent.min.js"></script>
<script type="text/javascript" src="/wp-content/themes/salient-child/js/main.js"></script>
   ...
   <!-- <link rel="stylesheet" type="text/css" href="<?php /*echo get_template_directory_uri() . '/css/jquery/jquery-ui.min.css?ver=1.1'; */?>" />-->
...
<script>
	jQuery(function() {
		...
		jQuery(".close_wrning").bind('click', function() {
...
<?php if ( $showexitpopup = get_field( 'show_exit_popup' ) ) { ?>
<div id="warning">
 <div class="warning_box">
    <span class="close_wrning">
      <img src="https://www.hoopesvision.com/wp-content/uploads/2019/03/dreams.metroeve_close-dreams-meaning.png">
    </span> 
	<?php dynamic_sidebar( 'exit-popup' ); ?>
 </div>
</div>
<?php } else { ?>
<?php } ?>
	...
	<header id="top">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col span_2 first-col">
					
					<a href="tel:+18015680200" class="phone-header"><img src="https://www.hoopesvision.com/wp-content/uploads/2018/11/phone.png"></a>
					<a id="logo" href="<?php echo home_url(); ?>" <?php echo $logo_class; ?>>
					<img src="<?php echo get_page_origin_field_value('logo'); ?>" alt="logo" />
				...
				<div class="col span_7 second-col">
				<?php
				...
				?>
					<div class="contact-wrap">Call <?php echo get_page_origin_field_value('phone_number'); ?></div>
				...
				<?php if($headerFormat == 'menu-left-aligned') { ?>
					<div class="col span_3 col_last third-col">
						<?php wp_nav_menu( array( 'theme_location' => 'top-right-menu', 'container_class' => 'top-right-nav' ) ); ?>
						<nav>
							<ul class="buttons" data-user-set-ocm="<?php echo $userSetSideWidgetArea; ?>">
